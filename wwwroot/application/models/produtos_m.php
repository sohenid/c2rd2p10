...
class Produtos_m extends CI_Model {
    ...
    public function getProdutos($q, $ord = NULL, $per_page = NULL, $offset = NULL) {
        ...
        $this->db->select('SQL_CALC_FOUND_ROWS id, categoria_id, descricao, preco, imagem, status, data_insert, data_update', FALSE);
        $query = $this->db->get('produto', $per_page, $offset);
